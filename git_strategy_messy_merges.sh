...
# use like _simple_mode_skip_step_check <branch> || return
...
# use like _simple_mode_skip_step_check <branch> <branch> || return
...
_merge_branch_into_branch Feature_2 Feature_3
_make_file_and_commit_from_branch Feature_3
